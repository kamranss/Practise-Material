...
#region Method for spliting string to parts and assigning to new Arr
...
#region Month method 
// input number and program will display the exact month which is assosiated with this number
//MonthMethod step1 = new MonthMethod();

//step1.number = int.Parse(Console.ReadLine());

//Console.WriteLine(step1.MonthName(step1.number));

//string[] newarr = { "1994.12.45", "1234.45.65" };
#endregion

#region Days of Week

// Input number and call the week day whihc assosiated with this number

WeekDays firstattempt = new WeekDays();
firstattempt.Wdays();
int m = int.Parse(Console.ReadLine());

firstattempt.Wdays(m);
